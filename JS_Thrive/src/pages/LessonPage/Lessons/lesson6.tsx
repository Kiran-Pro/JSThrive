          ...
          <div className="lesson-content">
            <section id="Introduction" className="lesson-section">
              ...
              <div className="figure">
                <p>
                  Conditions and loops are fundamental concepts in programming
                  that allow you to control the flow of your code. Think of
                  conditions as decision-making tools and loops as repetitive
                  tasks.
                </p>
            ...
            <section id="IfStatements" className="lesson-section">
              <h2>If Statements</h2>
              <p>
                If statements are used to make decisions in your code. If a
                condition is true, a block of code will run. If it's false, the
                block of code will be skipped. Here's an example:
              </p>
              <pre>
                <code>
                  <b>var</b> time = 10;
              ...
              <p>
                In this example, if the variable <b>time</b> is less than 12,
                the message "Good morning!" will be displayed.
              </p>
            </section>
            ...
            <section id="SwitchStatements" className="lesson-section">
              ...
              <p>
                Switch statements are used to perform different actions based on
                different conditions. They are like a series of if statements,
                but more organized. Here's an example:
              </p>
              <pre>
                <code>
                  <b>var</b> day = "Monday";
              ...
              <p>
                In this example, the message displayed will depend on the value
                of the variable <b>day</b>.
              </p>
            </section>
            ...
            <section id="ForLoops" className="lesson-section">
              ...
              <div className="figure">
                <p>
                  For loops are used to repeat a block of code a specified
                  number of times. They are great for tasks like counting or
                  iterating over arrays. Here's an example:
                </p>
              ...
              <p>
                In this example, the message "Number: " followed by the current
                value of <b>i</b> will be displayed five times, from 0 to 4.
              </p>
            </section>
            ...
            <section id="WhileLoops" className="lesson-section">
              ...
              <p>
                In this example, the message "Number: " followed by the current
                value of <b>i</b> will be displayed as long as <b>i</b> is less
                than 5.
              </p>
            </section>
            ...
            <section id="MoreConditionAndLoopFun" className="lesson-section">
              ...
              <p>
                Let's experiment with conditions and loops using the code editor
                below. Try creating different conditions and loops and see what
                results you get!
              </p>
              <JsEditor3
  ...
  i++;
            ...
            <section id="CodingStation" className="lesson-section">
              ...
              <p>
                ...
                editor below to experiment with conditions and loops and create
                your own examples!
              </p>
              <h2
                style={{
              ...
              <h4 style={{ textAlign: "center" }}>
                Use the code editor to create different conditions and loops to
