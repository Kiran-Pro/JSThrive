    ...
    return onSnapshot(
      ...
      (doc) => {
        if (doc.exists()) {
          ...
          setQuizCompleted(userData.lessonQuizzes?.lesson4 || false);
          ...
          <div className="lesson-content">
            <section id="Introduction" className="lesson-section">
              ...
              <div className="figure">
                <p>
                  Imagine you have a magical box that can store different
                  attributes about a person, such as their name, age, and
                  occupation. This box is called an object in JavaScript. An
                  object is a collection of key-value pairs where each key is a
                  unique identifier (like a label) and each value can be
                  anything, including numbers, strings, arrays, or even other
                  objects!
                </p>
                <img src={icon} alt="icon" width="300px" />
              </div>
              <p>
                Objects help us organize data in a structured way, making it
            ...
            <section id="CreatingObjects" className="lesson-section">
              ...
              <p>
                To create an object, you use curly braces <code>{"{}"}</code>{" "}
                and define key-value pairs inside them. Here's an example:
              </p>
              <pre>
                <code>
                  <b>var</b> person = {"{"} name: "Alice", age: 25, occupation:
                  "Engineer" {"}"};
                </code>
              </pre>
              <p>
                In this example, <b>person</b> is an object with three
                properties: <b>name</b>, <b>age</b>, and <b>occupation</b>. Each
                property has a key (like <b>name</b>) and a value (like
                "Alice").
              </p>
            </section>
            ...
            <section id="AccessingProperties" className="lesson-section">
              ...
              <p>
                You can access the properties of an object using dot notation or
                bracket notation. Here's how:
              </p>
              <pre>
                <code>
                  // Dot notation
              ...
              <p>
                Both notations work the same, but dot notation is more common
                and easier to read.
              </p>
            </section>
            ...
            <section id="MethodsInObjects" className="lesson-section">
              ...
              <p>
                Objects can also have functions as their properties. These
                functions are called methods. Let's add a method to our{" "}
                <b>person</b> object:
              </p>
              <pre>
                <code>
              ...
              <p>
                In this example, <b>greet</b> is a method that alerts a greeting
                message using the <b>name</b> property of the <b>person</b>{" "}
                object.
              </p>
            </section>
            ...
            <section id="MoreObjectFun" className="lesson-section">
              ...
              <p>
                Objects can contain other objects, arrays, and any data type in
                JavaScript. Let's create an object that contains an array and
                another object:
              </p>
              <pre>
                <code>
...
alert(student.address.city); // Outputs: Metropolis`}
            ...
            <section id="MoreObjectExamples" className="lesson-section">
              ...
              <p>
                Here are more examples to help you understand how objects work:
              </p>
              <pre>
                <code>
                  ...
                  &nbsp;year: 2020,
                  <br />
                  &nbsp;features: ["Air Conditioning", "Bluetooth", "Backup
                  Camera"],
                  <br />
                  &nbsp;owner: {"{"}
                  <br />
...
alert(car.owner.name); // Outputs: John`}
            ...
            <section id="CodingStation" className="lesson-section">
              ...
              <p>
                ...
                editor below to create your own objects and experiment with
              ...
              <h4 style={{ textAlign: "center" }}>
                Use the code editor to create an object representing your
                favorite book, including properties for title, author, and year
                published, and a method to display a description of the book.
              </h4>
              <Mini_IDE />
              <br />
