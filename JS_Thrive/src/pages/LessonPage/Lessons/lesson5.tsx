          ...
          <div className="lesson-content">
            <section id="Introduction" className="lesson-section">
              ...
              <div className="figure">
                <p>
                  Operators are special symbols in JavaScript that perform
                  operations on variables and values. Think of them as tools
                  that help you work with data. There are different types of
                  operators in JavaScript, each serving a unique purpose.
                </p>
            ...
            <section id="ArithmeticOperators" className="lesson-section">
              ...
              <p>
                Arithmetic operators perform basic mathematical operations like
                addition, subtraction, multiplication, and division. Here are
              ...
              <pre>
                <code>
                  ...
                  <br />a % b; // Modulus (remainder), outputs: 2
                </code>
              </pre>
              <p>
                Imagine you have 5 apples and you get 3 more. Using the addition
                operator (<b>+</b>), you now have 8 apples. Similarly, if you
                give away 2 of those apples, using the subtraction operator (
                <b>-</b>), you now have 6 apples left.
              </p>
            </section>
            ...
            <section id="ComparisonOperators" className="lesson-section">
              ...
              <p>
                ...
                value (true or false). Here are some common comparison
                operators:
              </p>
              <pre>
                <code>
                  ...
                  <br />a &lt;= b; // Less than or equal to, outputs: false
                </code>
              </pre>
              <p>
                Imagine comparing the ages of two people. If person A is 5 years
                old and person B is 3 years old, using the greater than operator
                (<b>&gt;</b>), you can see that person A is older than person B.
              </p>
            </section>
            ...
            <section id="LogicalOperators" className="lesson-section">
              ...
              <p>
                ...
                expressions or values. Here are the three main logical
                operators:
              </p>
              <pre>
                <code>
              ...
              <p>
                Imagine you have two conditions: "I have money" and "The store
                is open". If both conditions are true, using the AND operator (
                <b>&&</b>), you can go shopping. But if either condition is
                false, you cannot go shopping.
              </p>
            </section>
            ...
            <section id="AssignmentOperators" className="lesson-section">
              ...
              <pre>
                <code>
                  ...
                  <br />
                  a /= 2; // Equivalent to a = a / 2, outputs: 5
                  <br />a %= 2; // Equivalent to a = a % 2, outputs: 1
                </code>
              </pre>
              <p>
                Imagine you have a piggy bank with 5 coins. If you add 2 more
                coins, using the addition assignment operator (<b>+=</b>), you
                now have 7 coins. If you spend 2 coins, using the subtraction
                assignment operator (<b>-=</b>), you now have 5 coins again.
              </p>
            </section>
            ...
            <section id="MoreOperatorFun" className="lesson-section">
              ...
              <p>
                Let's experiment with operators using the code editor below. Try
                creating different expressions and see what results you get!
              </p>
              <JsEditor3
                defaultCode={`var a = 5;
var b = 3;
...
alert(a += b); // Outputs: 8`}
            ...
            <section id="CodingStation" className="lesson-section">
              ...
              <p>
                ...
                editor below to experiment with different operators and create
                expressions!
              </p>
              <h2
                style={{
              ...
              <h4 style={{ textAlign: "center" }}>
                Use the code editor to create different expressions using
