...
function Lesson3() {
  ...
  const [progress, setProgress] = useState(33); // Progress in percentage
        ...
        <div className='inner-con'>
          ...
          <div className="lesson-content">
            ...
            <section id="Introduction" className="lesson-section">
              ...
              <p>Arrays are like magical lists that can hold multiple items in a single variable. Imagine a treasure chest that can store a collection of valuable items like gold coins, jewels, and potions. In JavaScript, arrays can store numbers, strings, objects, and even other arrays.</p>
              <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                <img src={icon} alt="icon" width='300px' />
              </div>
              <p>Consider an array as a special box where you can keep a list of your favorite fruits: ["Apple", "Banana", "Mango"].</p>
            ...
            <section id="CreatingArrays" className="lesson-section">
              ...
              <p>To create an array, you can use square brackets and separate each item with a comma. Here’s an example:</p>
              <pre><code><b>var</b> fruits = ["Apple", "Banana", "Mango"];</code></pre>
              <p>Each item in the array is called an element, and they are accessed using their index (position) in the array. Indexes start from 0, so "Apple" is at index 0, "Banana" is at index 1, and "Mango" is at index 2.</p>
              <p>You can also create an empty array and add items later:</p>
              <pre><code><b>var</b> fruits = [];</code></pre>
              <p>Then you can use the <code>push</code> method to add items:</p>
              <pre><code>fruits.push("Apple");</code></pre>
              <pre><code>fruits.push("Banana");</code></pre>
              <pre><code>fruits.push("Mango");</code></pre>
              <br />
            ...
            <section id="ArrayMethods" className="lesson-section">
              <h2>Array Methods</h2>
              <p>JavaScript arrays come with a variety of built-in methods to help you manipulate and interact with the items they contain. Here are a few useful methods:</p>
              <ul>
                <li><strong>push(item):</strong> Adds an item to the end of the array.</li>
                ...
                <li><strong>unshift(item):</strong> Adds an item to the beginning of the array.</li>
                <li><strong>length:</strong> Returns the number of items in the array.</li>
                <li><strong>join(separator):</strong> Combines all array items into a single string, separated by the specified separator.</li>
              </ul>
              <br />
              <h2>Example</h2>
...
alert(fruits.join(", ")); // Output: Apple, Banana, Mango</code></pre>
            ...
            <section id="MoreArrayFun" className="lesson-section">
              ...
              <p>Arrays can store different types of data at the same time. You can have an array that contains numbers, strings, and even other arrays:</p>
              <pre><code><b>var</b> mixedArray = [42, "Hello", [1, 2, 3]];</code></pre>
              <p>Accessing elements in an array is easy. You can use the index to get an element:</p>
              <pre><code><b>var</b> firstFruit = fruits[0]; // Apple</code></pre>
...
alert(mixedArray[1]); // Hello`} onExecute={(code) => {
            ...
            <section id="MoreArrayExamples" className="lesson-section">
              ...
              <p>Here are more examples to help you understand how arrays work:</p>
              <pre><code>// Creating an array of numbers <br />
<b>var</b> numbers = [1, 2, 3, 4, 5];
alert(numbers.length); // 5</code></pre>
              <pre><code>// Adding and removing items <br />
numbers.push(6); // [1, 2, 3, 4, 5, 6]
numbers.pop(); // [1, 2, 3, 4, 5]</code></pre>
...
alert(numbers.join(" - ")); // "1 - 2 - 3 - 4 - 5"`} onExecute={(code) => {
            ...
            <section id="CodingStation" className="lesson-section">
              ...
              <Quiz question={question} correctAnswer={correctAnswer} badgeSrc={badge3} quizCompleted={quizCompleted} onCorrect={() => handleQuizCompletion(true)} />
            </section>
          </div>
        </div>
