...
function Lesson7() {
  ...
  const [progress, setProgress] = useState(77); // Progress in percentage
  ...
  const subscribeToUserData = (userId: string) => {
    ...
    return onSnapshot(userDocRef, (doc) => {
      if (doc.exists()) {
        ...
        setQuizCompleted(userData.lessonQuizzes?.lesson7 || false); // Load quiz completion state for lesson 7
    ...
    if (isCorrect && user && !quizCompleted) {
      ...
      try {
        await updateDoc(userDocRef, {
          ...
          [`lessonQuizzes.lesson7`]: true, // Mark the lesson7 quiz as completed
        });
        ...
        <div className="inner-con">
          ...
          <div className="lesson-content">
            <section id="Introduction" className="lesson-section">
              ...
              <p>
                Functions are like magical recipes in JavaScript. They allow you to create reusable blocks of code that perform specific tasks. Think of a function as a set of instructions that you can call whenever you need to perform that task. Just like a recipe, a function takes ingredients (called parameters) and follows steps to produce a result.
              </p>
            ...
            <section id="DefiningFunctions" className="lesson-section">
              ...
              <p>
                To define a function, you use the <b>function</b> keyword followed by a name, parentheses, and curly braces. The code inside the curly braces is the function's body. Here's an example:
              </p>
              <pre>
                <code>
              ...
              <p>
                In this example, we defined a function named <b>sayHello</b> that displays an alert with the message "Hello, world!".
              </p>
            </section>
            ...
            <section id="CallingFunctions" className="lesson-section">
              ...
              <p>
                To call a function, you simply use its name followed by parentheses. Here's how you call the <b>sayHello</b> function:
              </p>
              <pre>
                <code>
                  sayHello();
              ...
              <p>
                When you call the function, the code inside the function's body will run.
              </p>
            </section>
            ...
            <section id="FunctionParameters" className="lesson-section">
              ...
              <p>
                Functions can take inputs called parameters. You can define parameters inside the parentheses when you define the function. Here's an example:
              </p>
              <pre>
                <code>
              ...
              <p>
                In this example, the <b>greet</b> function takes one parameter called <b>name</b>. When you call the function, you can pass a value for the parameter:
              </p>
              <pre>
                <code>
            ...
            <section id="ReturnValues" className="lesson-section">
              <h2>Return Values</h2>
              <p>
                Functions can also return values. You use the <b>return</b> keyword to specify the value that should be returned. Here's an example:
              </p>
              <pre>
                <code>
              ...
              <p>
                In this example, the <b>add</b> function takes two parameters, <b>a</b> and <b>b</b>, and returns their sum. You can store the returned value in a variable:
              </p>
              <pre>
                <code>
            ...
            <section id="FunctionExpressions" className="lesson-section">
              ...
              <p>
                In JavaScript, you can also define functions using function expressions. A function expression is when you assign a function to a variable. Here's an example:
              </p>
              <pre>
                <code>
              ...
              <p>
                In this example, we defined a function that multiplies two numbers and assigned it to the variable <b>multiply</b>. You can call this function using the variable name:
              </p>
              <pre>
                <code>
            ...
            <section id="ArrowFunctions" className="lesson-section">
              ...
              <p>
                Arrow functions are a shorthand way to write functions in JavaScript. They are especially useful for writing short functions. Here's an example:
              </p>
              <pre>
                <code>
              ...
              <p>
                In this example, we defined an arrow function that subtracts two numbers. Arrow functions are great for simplifying your code and making it more readable.
              </p>
            </section>
            ...
            <section id="MoreFunctionFun" className="lesson-section">
              ...
              <p>
                Let's experiment with functions using the code editor below. Try creating different functions and see what results you get!
              </p>
              <JsEditor3
...
alert(result); // Outputs: 5`}
            ...
            <section id="CodingStation" className="lesson-section">
              ...
              <p>
                Ready to try it yourself? Let's use the magic vortex - code editor below to experiment with functions and create your own examples!
              </p>
              <h2 style={{ color: 'var(--highlight-color2)', textAlign: 'center' }}>Let's get into Vortex - Play Around</h2>

              <h4 style={{ textAlign: 'center' }}>
                Use the code editor to create different functions and see what you can do with them.
              </h4>
              <Mini_IDE />
              <br />
              <h2 style={{ textAlign: 'center' }}>Here's a Quiz</h2>

              <Quiz question={question} correctAnswer={correctAnswer} badgeSrc={badge7} quizCompleted={quizCompleted} onCorrect={() => handleQuizCompletion(true)} />
            </section>
          </div>
        </div>
